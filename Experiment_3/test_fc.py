...
test_path = r'/scratch0/tianqiwu/project/UCL_MSc_dsml_project/data_extraction/AbideTestNewExtractedAxial.h5'
test_path = r'/scratch0/tianqiwu/project/UCL_MSc_dsml_project/data_extraction/AbideValidNewExtractedAxial.h5'
...
# label_path = '/scratch0/tianqiwu/project/UCL_MSc_dsml_project/overall_test/label_axial.pkl'
# with open(label_path, 'wb') as f:
#     pickle.dump(test_all_labels, f)
...
for nth_try in range(1,101):
    ...
    # score_path = f'./FCsavedscore/fc_test{nth_dcnn}r.pkl'
