...
# load data set
train_path = r'/scratch0/tianqiwu/project/UCL_MSc_dsml_project/data_extraction/AbideTrainNewExtractedAxial.h5'
# define validation data path
val_path = r'/scratch0/tianqiwu/project/UCL_MSc_dsml_project/data_extraction/AbideValidNewExtractedAxial.h5'
...
for nth_try in range(1,101):
    ...
    saved_model_name2 = f'./FCmodel/{nth_dcnn}/balance{nth_try}.pt'
