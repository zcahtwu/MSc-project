...
train_path = r'/scratch0/tianqiwu/project/UCL_MSc_dsml_project/data_extraction/AbideTrainSujitNewNormalization_Axial.h5'
# define validation data path
val_path = r'/scratch0/tianqiwu/project/UCL_MSc_dsml_project/data_extraction/AbideValidSujitNewNormalization_Axial.h5'
...
for nth_try in range(1,101):
    ...
    # Define path etc
    print("==================")
    # print(f'The {nth_try} th repeats, seed = {nth_try-1}')

    # saved_model_name1 = f'./FCmodel/accfc{nth_try}.pt'
    saved_model_name2 = f'./FCmodel/{nth_dcnn}r/balance{nth_try}.pt'
    ...
    for epoch in range(n_epoch):
        ...
        train_balanced_acc = balanced_accuracy_score(train_label_list,train_pred_list)
        ...
        with torch.no_grad():
            ...
            for j in range(int((length_val/n_slices))):
                ...
                val_pred_list.append(predicted)
    ...
    picked_epoch1 = val_acc_list.index(max(val_acc_list))+1
    picked_epoch2 = val_balanced_acc_list.index(max(val_balanced_acc_list))+1
    # print(f'Pick epoch {picked_epoch1} and {picked_epoch2} as final model.')
