...
for epoch in range(n_epoch):
    ...
    print(f'Epoch[{epoch+1}] T acc={trainacc},T balanced acc={trainbalanceacc},T sensitivity={trainsensiticity} V acc={valacc}, V balanced acc:{valbalanceacc},V sensitivity={valsensitivity}, T auc = {auc_train}, V auc = {auc_val}, T loss:{trainloss}, V loss = {valloss}')
...
print(f'Pick epoch {picked_epoch1},{picked_epoch2} as final model.')
