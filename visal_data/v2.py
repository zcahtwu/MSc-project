...
fc_path = f'/scratch0/tianqiwu/project/UCL_MSc_dsml_project/{current}/FCsavedscore/fc_test1r.pkl'
# fc_path = f'/scratch0/tianqiwu/project/UCL_MSc_dsml_project/{current}/FCsavedscore/val1.pkl'
dcnn_path = f'/scratch0/tianqiwu/project/UCL_MSc_dsml_project/{current}/DCNNsavedscore/DCNNscore_test1.pkl'
...
for i, data in enumerate(loader, 0):
    ...
    # current_slice = batch_image[]
        ax.imshow(np.fliplr(batch_image[31-n,0,:, :]), cmap='gray', origin='upper')
        ax.axis('off')   
        ax.set_title(f'{round(slice_score[31-n],3)}', fontsize=20)
