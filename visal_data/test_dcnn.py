...
# test_path = r'/scratch0/tianqiwu/project/UCL_MSc_dsml_project/Dataset/AbideTestSujitNewNormalization_Axial.h5'
...
net = Net()
# load saved model
saved_model = '/scratch0/tianqiwu/project/UCL_MSc_dsml_project/Axial/DCNNmodel/dcnn_balanced1.pt'
